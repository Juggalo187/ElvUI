-- !! Atlas loot skin needs to be redone !!
...
-- 	AtlasLootDefaultFrameNineSlice:StripTextures()

-- 	S:HandleCloseButton(AtlasLootDefaultFrameCloseButton, AtlasLootDefaultFrame)
...
-- 	AtlaslLoot_LootBackground:SetTemplate("Transparent")
...
-- 	AtlasLootDefaultFrame_ExpansionMenu:Point("RIGHT", AtlaslLoot_LootBackground, "RIGHT", 0, 0)
-- 	Atlasloot_Difficulty_ScrollFrame:Point("TOPLEFT", AtlasLootDefaultFrame_ExpansionMenu, "TOPRIGHT", 5, 0)
-- 	Atlasloot_SubTableFrame:Point("BOTTOMLEFT", AtlaslLoot_LootBackground, "BOTTOMRIGHT", 5, 0)
-- 	AtlasLootDefaultFrame_Preset1:Point("LEFT", AtlasLootDefaultFrameWishListButton, "RIGHT", 5, 0)
-- 	AtlasLootDefaultFrame_Preset4:Point("RIGHT", AtlaslLoot_LootBackground, "RIGHT", 0, 0)
...
-- 	AtlasLootDefaultFrame_AdvancedSearchPanel_CloseButton:Point("TOPRIGHT", AtlaslLoot_LootBackground, "TOPRIGHT", -2, -3)
-- 	AtlasLootDefaultFrame_AdvancedSearchPanel_SearchBox.title:Point("TOPLEFT", AtlaslLoot_LootBackground, "TOPLEFT", 24, -49)
...
-- 	AtlasLootDefaultFrame_AdvancedSearchPanel_QualityButton.title:Point("TOPLEFT", AtlaslLoot_LootBackground, "TOPLEFT", 309, -49)
